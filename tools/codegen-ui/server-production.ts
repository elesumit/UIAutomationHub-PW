 ...
 */
app.post('/api/start-recording', (req: any, res: any) => {
 ...
 */
app.post('/api/stop-recording', (req: any, res: any) => {
  if (!codegenProcess) {
 ...
 */
app.post('/api/convert-to-gherkin', (req: any, res: any) => {
 ...
 * Save feature file
 */
app.post('/api/save-feature', (req: any, res: any) => {
...
app.listen(PORT, HOST, () => {
  console.log(`
🚀 Codegen UI Server Running in Production Mode!

📝 Access URL: http://${HOST === '0.0.0.0' ? '<server-ip>' : HOST}:${PORT}
